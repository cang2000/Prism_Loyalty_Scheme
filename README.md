...
![Segmentation — city and gender split](assets/segmentation.png)*Bar chart visualising the top 3 cities by user count followed by a column chart displaying the gender split*
